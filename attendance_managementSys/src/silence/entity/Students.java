...
public class Students implements Serializable {
	...
	private String integrals; // 学生性别
	public Students() {
	}
	public Students(Integer id, String stuNo, String stuName, Integer classId, String stuPwd, String stuGender,
			String integrals) {
		this.id = id;
		this.stuNo = stuNo;
	...
	public String toString() {
		return "Students [id=" + id + ", stuNo=" + stuNo + ", stuName=" + stuName + ", classId=" + classId + ", stuPwd="
				+ stuPwd + ", stuGender=" + stuGender + ", integrals=" + integrals + "]";
	}
