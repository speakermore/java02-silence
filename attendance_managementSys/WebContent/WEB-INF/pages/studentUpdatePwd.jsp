	...
	<div class="container">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form action="stuAttendance/updateStuPwd" role="form"
					...
					<div class="form-group">
						...
						<div class="col-xs-4">
							...
							<input type="password" id="oldPwd" name="stuOldPwd"
					...
					<div class="form-group">
						...
						<div class="col-xs-4">
							<input type="password" id="newPwd" name="stuNewPwd"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-xs-4">
							<input type="password" id="confirmPwd" name="stuRePwd"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-xs-offset-4">
							<input type="submit" id="btn" class="btn btn-primary col-xs-5"
								style="margin-left: 35px;" value="提交" />
						</div>
					</div>
					<div id="remind">${message}</div>
					<input type="hidden" id="stuId" name="id" value="${student.id}" />
				</form>
			</div>
		</div>
	</div>
